...
pass_rush = pd.read_csv('pass_rush_tagged.csv', index_col = 0)
...
all_stunt_frames = all_stunt_frames[['gameId','playId','nflId','frameId','time', 'team',
                                     'x_rel','y_rel','o_rel','dir_rel', 's', 'a',
                                     'pff_hit', 'pff_hurry', 'pff_sack','qb_x_rel', 'qb_y_rel']]

stunt_info_df.to_csv('stunt_info.csv')
matchup_df_all.to_csv('matchups.csv')
all_stunt_frames.to_csv('stunt_frames.csv')
