...
stunt_info = pd.read_csv('stunt_info.csv', index_col = 0)
matchups = pd.read_csv('matchups.csv', index_col = 0)
stunt_frames = pd.read_csv('stunt_frames.csv', index_col = 0)
...
shared_columns = list(stunt_info.columns) + ['frameId', 'time', 'team', 'ball_snapped']
...
# "Standard deviation" -style squareness, more robust to one extreme value
pro_frames_merge['dev_squareness'] = np.sqrt(pro_frames_merge['squareness_out']**2 + 
...
pro_frames_merge['dev_qb_squareness'] = np.sqrt(pro_frames_merge['qb_squareness_out']**2 + 
...
pro_frames_merge.to_csv('pro_frames_merge_2v2.csv')
stunt_info.to_csv('stunt_info.csv')
